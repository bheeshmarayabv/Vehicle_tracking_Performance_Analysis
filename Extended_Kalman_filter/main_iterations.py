...
def plot_data(all_ground_truths, all_state_estimations,sensor_data,x_predictions,y_predictions,filename,i):
...
for i in range(2,4):
    print(i)
    all_sensor_data, all_ground_truths = parse_data("data/"+filename,i)
    ...
    plot_data(all_ground_truths,all_state_estimations,all_sensor_data,x_predictions,y_predictions,filename,i)
